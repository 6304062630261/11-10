  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          Padding(
            padding: const EdgeInsets.only(right: 16.0), // เพิ่ม Padding ด้านขวา
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: isSelected ? Colors.pink[500] : Colors.pink[300], // เปลี่ยนสีให้สดขึ้น
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(5), // เปลี่ยนจากมุมมนเล็กน้อย
                        color: isSelected ? Colors.pink[500] : Colors.pink[300],),
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text(
